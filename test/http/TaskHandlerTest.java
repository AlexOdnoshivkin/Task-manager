...
public class TaskHandlerTest {
    ...
    @Test
    void GetTasks_WhileCorrectResponse_ShouldReturnAllTasks() {
    ...
    @Test
    void GetTaskById_WhileCorrectResponse_ShouldReturnTask() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task?id=" + task1.getId());
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
                .GET()
                .build();
    ...
    @Test
    void GetTaskById_WhileRequestEpicId_ShouldReturnErrorCode() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task?id=" + epic1.getId());
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
                .GET()
                .build();
    ...
    @Test
    void PostTask_WhileCorrectResponse_ShouldCrateTask() {
        HttpClient httpClient = HttpClient.newHttpClient();
        Task newTask = new Task("NewTask", "description",
                LocalDateTime.of(2022, 5, 29, 10, 0), Duration.ofMinutes(170));
        ...
        URI GetUri = URI.create("http://localhost:8080/tasks/task?id=" + newTask.getId());
        ...
        try {
            ...
            Task task = manager.getTaskById(newTask.getId());
    ...
    @Test
    void PostTask_WhileIncorrectTaskType_ShouldReturnErrorCode() {
        HttpClient httpClient = HttpClient.newHttpClient();
    ...
    @Test
    void UpdateTask_WhileTaskNotCreated_ShouldReturnErrorCode() {
        HttpClient httpClient = HttpClient.newHttpClient();
        Task newTask = new Task("NewTask", "description",
                LocalDateTime.of(2022, 5, 29, 10, 0), Duration.ofMinutes(170));
        String json = gson.toJson(newTask);
    ...
    @Test
    void UpdateTask_WhileCorrectResponse_ShouldCrateTask() {
        HttpClient httpClient = HttpClient.newHttpClient();
        Task newTask = task1;
    ...
    @Test
    void DeleteAllTasks_WhileCorrectResponse_ShouldDeleteAllTasks() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task");
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
        ...
        URI GetUri = URI.create("http://localhost:8080/tasks/task");
        HttpRequest GetRequest = HttpRequest.newBuilder()
                .uri(GetUri)
                .GET()
                .build();
    ...
    @Test
    void DeleteTaskById_WhileCorrectResponse_ShouldDeleteAllTasks() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task?id=" + task1.getId());
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
    ...
    @Test
    void DeleteTaskById_WhileIncorrectTaskType_ShouldDeleteAllTasks() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task?id=" + epic1.getId());
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
    ...
    @Test
    void DeleteTaskById_WhileRequestNonExistentId_ShouldDeleteAllTasks() {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI uri = URI.create("http://localhost:8080/tasks/task?id=100");
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(uri)
